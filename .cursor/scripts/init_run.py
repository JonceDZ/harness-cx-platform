...
Usage:
    python .cursor/scripts/init_run.py "build order lookup agent" --target order-bot
    python .cursor/scripts/init_run.py "add tracking tool" --target order-bot --mode edit
    python .cursor/scripts/init_run.py --latest-open
    python .cursor/scripts/init_run.py --latest-open --target order-bot
"""
